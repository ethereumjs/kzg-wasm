...
[ "_load_trusted_setup_file_from_wasm", "_free_trusted_setup_wasm", "_blob_to_kzg_commitment_wasm", "_compute_blob_kzg_proof_wasm", "_verify_blob_kzg_proof_wasm", "_verify_kzg_proof_wasm", "_memory", "___emscripten_embedded_file_data", "___indirect_function_table", "__ZN6__asan9FakeStack17AddrIsInFakeStackEm", "__ZN6__asan9FakeStack8AllocateEmmm", "___set_stack_limits", "onRuntimeInitialized" ].forEach(prop => {
...
var wasmSourceMapFile = "kzg.wasm.map";
...
var __emscripten_fs_load_embedded_files = ptr => {
 do {
  var name_addr = _asan_js_load_4u(((ptr) >> 2));
  ptr += 4;
  var len = _asan_js_load_4u(((ptr) >> 2));
  ptr += 4;
  var content = _asan_js_load_4u(((ptr) >> 2));
  ptr += 4;
  var name = UTF8ToString(name_addr);
  FS.createPath("/", PATH.dirname(name), true, true);
  FS.createDataFile(name, null, HEAP8.subarray(content, content + len), true, true, true);
 } while (_asan_js_load_4u(((ptr) >> 2)));
};
...
var _load_trusted_setup_file_from_wasm = Module["_load_trusted_setup_file_from_wasm"] = createExportWrapper("load_trusted_setup_file_from_wasm");
...
var ___emscripten_embedded_file_data = Module["___emscripten_embedded_file_data"] = 307245916;
